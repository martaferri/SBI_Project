...
# ref_counter_original=copy.copy(ref_counter)
                    ...
                    for ele in ref_counter:
                        ...
                        if ref_counter[i_chain] != 0:
                            ...
                            if len(fixed_atoms_list) != len(moving_atoms_list):
                                ...
                                fixedchain_result = get_chain_refined(fixedchain, fixed_pattern)
                                movingchain_result = get_chain_refined(movingchain, moving_pattern)

                                fixed_atoms_list = get_atoms_list(fixedchain_result)
                                moving_atoms_list = get_atoms_list(movingchain_result)

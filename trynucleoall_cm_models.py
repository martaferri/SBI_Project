...
# model_name="A_B_a"
# pdb_out_filename = outputs + str(model_name) + ".aligned.pdb"
# fo=open(pdb_out_filename,"w")
# fo.write("holis")
# fo.close()
